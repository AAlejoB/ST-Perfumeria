...
-- ─────────────────────────────────────────────────────────────────────────
-- fase4a · SECCIONES 1-5 (helper + avisos en cliente_login / cliente_editar /
-- cliente_reset_solicitar + trigger de lista_espera). NO toca permisos.
-- Se corre PRIMERO, con el JS viejo todavía en el aire: desde acá los avisos
-- salen DUPLICADOS (servidor + front) — esa es la ventana segura.
-- Partido de sql/fase4_telegram.sql (referencia completa) el 19-sep-2026 para
-- que cada mitad tenga su propio begin/commit: pegar una parte de una
-- transacción sin el commit puede no persistir en el SQL Editor.
-- ─────────────────────────────────────────────────────────────────────────
