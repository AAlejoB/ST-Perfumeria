...
> **Desde 26-sep-2026** (`[VALOR-INV-DEPOSITO]`, `f461ef3`) la tarjeta 💰 de Precios & Stock (`data-role="jefe"`) es el **valor total de inventario**: local + depósito, a precio de lista (la promo si la hay), **con los pausados** (decisión de Alejo, `[VALOR-INV-PAUSADOS]`, v1.1.134) y sin sets (decisión de Alejo, 26-sep), con el desglose exacto debajo: local, depósito y cuánto de eso es de pausados. Las otras tarjetas siguen sin contar los pausados. Es ocultamiento visual, como el resto de los roles: la empleada lee los mismos precios y cantidades.
...
- **`[VALOR-INV-DISEÑO]`** (26-sep, salió de `[VALOR-INV-DEPOSITO]` · 🟢) — Alejo lo piensa con el DISEÑADOR cuando tenga tiempo: la tarjeta 💰 del jefe mide 154,9 px (172,8 de 901 a 950) contra 86,8 de las otras, que en 4 columnas se estiran y quedan con aire abajo; y si «⏸️ Incluye pausados» en gris se lee como «parte de» y no como «más». Los sets quedan afuera del valor (decisión de Alejo, 26-sep).
