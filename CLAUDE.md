...
- **`[COMPARE-PISA-NOMBRE]`** (24-sep, salió de la N-bis · 🟢) — a 1280, el botón «Comparar» (`.compare-btn`) se cruza con el nombre de la card: en **108 de 186** cards visibles, espejadas y normales (78 × 9 a 24 px). **Ya pasaba igual en v1.1.130** (`2a588ea`): no lo trajo la N. Arreglarlo es mover el botón (o el nombre): es del DISEÑADOR.
