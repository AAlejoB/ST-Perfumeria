...
Si no lo bumpeás, los usuarios siguen viendo el archivo viejo cacheado. Versión actual al momento de escribir esto: **v1.1.134** (26-sep-2026, `[VALOR-INV-PAUSADOS]`).
...
> **Desde 26-sep-2026** (`[VALOR-INV-DEPOSITO]`, `f461ef3`) la tarjeta 💰 de Precios & Stock (`data-role="jefe"`) es el **valor total de inventario**: local + depósito, a precio de lista (la promo si la hay), **con los pausados** (decisión de Alejo, `[VALOR-INV-PAUSADOS]`, v1.1.134) y sin sets, con el desglose exacto debajo: local, depósito y cuánto de eso es de pausados. Las otras tarjetas siguen sin contar los pausados. Es ocultamiento visual, como el resto de los roles: la empleada lee los mismos precios y cantidades.
